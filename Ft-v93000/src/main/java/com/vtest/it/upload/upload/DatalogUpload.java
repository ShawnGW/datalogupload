...
import com.vtest.it.common.tools.FileUpload.ft.impl.V93kQueueNeddUpload;
...
public class DatalogUpload {
    public static void main(String[] args) throws ParseException, IOException {
        ...
        QueueNeedUpload queueNeedUpload = new V93kQueueNeddUpload();
        ...
        GenerateLog.generateLog(Properties.LOG_PATH, upload.upload(fileNeedUploadQueue, "/V93000/"));
    }
}
